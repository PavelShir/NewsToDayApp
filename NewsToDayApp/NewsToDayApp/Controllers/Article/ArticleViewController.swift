...
final class ArticleViewController: UIViewController {
    ...
    private func configuration() {
        ...
        let autor = "Author"
        let attributes1 = [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 16, weight: .semibold)]
    ...
    private func setupLikedState() {
        ...
        let bookmarkImage = liked ? UIImage(systemName: "bookmark.fill") : UIImage(systemName: "bookmark")
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            labelAuthor.topAnchor.constraint(equalTo: labelDescription.bottomAnchor, constant: 8),
